...
export const colaboradoresData = [
  ...
  { id: 2, name: 'Camila Herrera', email: 'camila.herrera@trabajito.com', depto: 'Ventas', cargo: 'Ejecutiva Comercial', rol: 'Colaborador', ingreso: '02 Ene 2026', status: 'activo', registro: 100, onb: 'sin-iniciar', onbPct: 0, initials: 'CH', color: '#f97316', buddy: BUDDY_MARTIN, jefe: JEFE_NICOLAS },
  ...
  { id: 5, name: 'Sofía Ramírez', email: 'sofia.ramirez@trabajito.com', depto: 'Ventas', cargo: 'Pasante Comercial', rol: 'Colaborador', ingreso: '10 Jun 2026', status: 'activo', registro: 60, onb: 'sin-ruta', initials: 'SR', color: '#f59e0b', jefe: JEFE_NICOLAS },
  ...
  { id: 7, name: 'Luciana Paredes', email: 'luciana.paredes@trabajito.com', depto: 'Ventas', cargo: 'Account Manager', rol: 'Colaborador', ingreso: '17 Jun 2026', status: 'activo', registro: 40, onb: 'sin-ruta', initials: 'LP', color: '#0d9488', jefe: JEFE_NICOLAS },
  ...
  { id: 11, name: 'Andrea Núñez', email: 'andrea.nunez@trabajito.com', depto: 'Marketing', cargo: 'Community Manager', rol: 'Colaborador', ingreso: '22 Sep 2025', status: 'activo', registro: 100, onb: 'en-curso', onbPct: 55, initials: 'AN', color: '#06b6d4', buddy: BUDDY_DIEGO, jefe: JEFE_ANA },
  ...
  { id: 13, name: 'Carolina Vega', email: 'carolina.vega@trabajito.com', depto: 'Marketing', cargo: 'Analista de Marketing', rol: 'Colaborador', ingreso: '08 Mar 2025', status: 'activo', registro: 100, onb: 'graduado', onbPct: 100, initials: 'CV', color: '#14b8a6', buddy: BUDDY_DIEGO, jefe: JEFE_ANA },
  ...
  { id: 18, name: 'Mateo Guzmán', email: 'mateo.guzman@trabajito.com', depto: 'Ventas', cargo: 'SDR Junior', rol: 'Colaborador', ingreso: '25 Jun 2026', status: 'activo', registro: 75, onb: 'sin-ruta', initials: 'MG', color: '#ca8a04', jefe: JEFE_NICOLAS },
  ...
  { id: 21, name: 'Valeria Rojas', email: 'valeria.rojas@trabajito.com', depto: 'Marketing', cargo: 'Content Creator', rol: 'Colaborador', ingreso: '07 Ago 2025', status: 'activo', registro: 100, onb: 'graduado', initials: 'VR', color: '#c026d3', jefe: JEFE_ANA },
  ...
  { id: 25, name: 'Ana Martínez Ruiz', email: 'ana.martinez@trabajito.com', depto: 'Marketing', cargo: 'Líder de Marketing', rol: 'Líder de área', ingreso: '19 Feb 2024', status: 'activo', registro: 100, onb: 'n-a', initials: 'AM', color: '#c026d3' },
  { id: 26, name: 'Bruno Salazar', email: 'bruno.salazar@trabajito.com', depto: 'Marketing', cargo: 'Especialista SEO', rol: 'Colaborador', ingreso: '01 Jun 2026', status: 'activo', registro: 100, onb: 'en-riesgo', onbPct: 18, initials: 'BS', color: '#f43f5e', buddy: BUDDY_MARTIN, jefe: JEFE_ANA },
  { id: 27, name: 'Natalia Ferrer', email: 'natalia.ferrer@trabajito.com', depto: 'Marketing', cargo: 'Ejecutiva de Marca', rol: 'Colaborador', ingreso: '15 Jun 2026', status: 'activo', registro: 100, onb: 'sin-iniciar', onbPct: 0, initials: 'NF', color: '#8b5cf6', jefe: JEFE_ANA },
  // Dirección General: son la punta del organigrama, por eso existen en el directorio.
  { id: 28, name: 'Ricardo Ballivián', email: 'ricardo.ballivian@trabajito.com', depto: 'Dirección General', cargo: 'Gerente General', rol: 'Gerente', ingreso: '02 Ene 2023', status: 'activo', registro: 100, onb: 'n-a', initials: 'RB', color: '#0C2D40' },
  { id: 29, name: 'Lorena Aguirre', email: 'lorena.aguirre@trabajito.com', depto: 'Dirección General', cargo: 'Asistente de Dirección', rol: 'Colaborador', ingreso: '18 Mar 2023', status: 'activo', registro: 100, onb: 'n-a', initials: 'LA', color: '#0891b2' },
]
