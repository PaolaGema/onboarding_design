...
export const colaboradoresData = [
  ...
  { id: 13, name: 'Carolina Vega', email: 'carolina.vega@trabajito.com', depto: 'Marketing', cargo: 'Analista de Marketing', rol: 'Colaborador', ingreso: '08 Mar 2025', status: 'activo', registro: 100, onb: 'graduado', onbPct: 100, initials: 'CV', color: '#14b8a6', buddy: BUDDY_DIEGO },
