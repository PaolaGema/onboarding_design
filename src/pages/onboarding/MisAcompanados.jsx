...
export default function MisAcompanados() {
        ...
        <div className="sec-card">
          <div style={{ padding: 48, textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 12, color: 'var(--text-muted)', marginTop: 6, maxWidth: 380, margin: '6px auto 0' }}>
              Cuando Recursos Humanos te asigne como buddy de alguien, esa persona aparecerá aquí con su avance y su recorrido.
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="sec-card">
          <div className="sc-body" style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <span style={{ fontSize: 11.5, color: 'var(--text-muted)', lineHeight: 1.5 }}>
              Como buddy ves el avance general y el recorrido. El detalle de las respuestas,
  ...
  return (
    <div className="content-scroll" onClick={() => setEstadoOpen(false)}>
      ...
      {/* Con dos tarjetas, el `1fr` de la tira las estira a media pantalla cada una. El tope
          les deja el mismo ancho que tienen donde hay tres. */}
      <div className="kpi-strip" style={{ maxWidth: 620 }}>
