...
const samplePlantillasBase = [
  ...
  { id: 4, name: 'Onboarding Operaciones', area: 'Operaciones', cargo: 'Analista de Procesos', tipo: 'Onboarding', etapas: 9, tareas: 25, asignados: 3, status: 'activa', updated: 'Hace 1 semana', updatedFecha: '24/06/2026', creador: 'Ana Martínez Ruiz', creadorRole: 'Líder de Área — Marketing', creadoEl: '20/01/2026', color: '#f59e0b' },
  { id: 5, name: 'Onboarding Tech — Backend', area: 'Tecnología', cargo: 'Desarrollador Backend', tipo: 'Onboarding', etapas: 14, tareas: 40, asignados: 4, status: 'activa', updated: 'Hace 3 días', updatedFecha: '28/06/2026', creador: 'Juan Pérez Gómez', creadorRole: 'Administrador HR', creadoEl: '05/12/2025', color: '#06b6d4' },
  { id: 6, name: 'Onboarding Finanzas', area: 'Finanzas', cargo: 'Analista Financiera', tipo: 'Onboarding', etapas: 7, tareas: 18, asignados: 0, status: 'borrador', updated: 'Ayer', updatedFecha: '30/06/2026', creador: 'Juan Pérez Gómez', creadorRole: 'Administrador HR', creadoEl: '15/06/2026', color: '#f97316' },
